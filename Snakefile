...
include: "rules/gatk3_fasta_dict.rules"
include: "rules/gatk3_haplotypecaller_diploid.rules"
include: "rules/gatk3_haplotypecaller_tetraploid.rules"
include: "rules/gatk3_genotype_gvcfs.rules"
